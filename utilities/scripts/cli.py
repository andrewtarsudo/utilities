...
#             continue
#
#         elif isinstance(param, OptionInfo):
...
#
#
# def format_options(cmd: TyperCommand, ctx: Context, formatter: HelpFormatter) -> None:
...
#
#
# def format_epilog(cmd: TyperCommand, parent: Context = None, formatter: HelpFormatter = None) -> None:
#     if parent is None:
...
#
#
# def format_help(cmd: TyperCommand, ctx: Context, formatter: HelpFormatter) -> None:
...
# def format_args(cmd: TyperCommand, ctx: Context, formatter: HelpFormatter):
#     args: list[Argument] = [
...
#
#
# def get_help(cmd: TyperCommand, ctx: Context) -> str:
...
#     commands: dict[str, TyperCommand] = getattr(cmd, "commands", dict())
#
